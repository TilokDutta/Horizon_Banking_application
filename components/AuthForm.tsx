...
const AuthForm = ({ type }: { type: string }) => {
    ...
    return (
        ...
        {user ? (
            <div className="flex lfex-col gap-4">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        {type === 'sign-up' && (
                            <>
                                ...
                                <CustomInput control={form.control} name="city" label="City" placeholder="ex: Mogra"/>
                                <div className="flex gap-5">
                                    <CustomInput control={form.control} name="state" label="State" placeholder="ex: NY"/>
                                    <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="ex: 712568"/>
                                </div>
                                <div className="flex gap-5">
